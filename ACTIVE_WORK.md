...
| `TASK-TRN-01` | Repair and verify Drivers & Vehicles foundation | Unassigned (CHANGES_REQUIRED) | `codex/transport-foundation-repair` | Transport domain, application, cloud adapter, UI, forward migration and regression tests | `CHANGES_REQUIRED` | Transport schema/RPC/RLS/realtime; EventShell lifecycle | Independent audit reopened status to CHANGES_REQUIRED. Requires spec alignment, realtime/reconciliation repair, restore workflow, and failure classification before takeover. |
...
`TASK-TRN-01` was reopened as **CHANGES_REQUIRED**. Before any `TASK-TRN-02` implementation:
